...
async function buildScheduleWorkbook({ monthKey, branchCode, areaCode, roleCode }) {
...
export async function GET(request) {
  ...
  try {
    ...
    const excel = await buildScheduleWorkbook({ monthKey, branchCode, areaCode, roleCode });
