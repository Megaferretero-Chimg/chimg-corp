...
import styles from "@/modules/planner/styles/components/planning/PlanningSummary.module.scss";
...
const QUICK_LINKS = [
  ...
  },
  {
    ...
    description: "Crear, editar y revisar novedades por empleado.",
  ...
  useEffect(() => {
    ...
    async function loadSummary() {
      ...
      try {
        ...
        const response = await fetch(`/api/planner/planning/summary?${params.toString()}`);
