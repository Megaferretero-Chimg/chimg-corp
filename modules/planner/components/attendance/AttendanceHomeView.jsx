...
import styles from "@/modules/planner/styles/components/attendance/AttendanceHomeView.module.scss";
...
export default function AttendanceHomeView() {
  ...
  const isFilterDisabled = isPending;
      ...
      <div className={styles.filterBar}>
        ...
        <label>
          ...
          <select
            ...
            onChange={(event) => updateFilters({ areaCode: event.target.value })}
            disabled={isFilterDisabled}
          >
            <option value="">Todas</option>
        ...
        <button type="button" onClick={() => loadComparison(filters)} disabled={isFilterDisabled}>
          <RefreshCw size={16} />
          Actualizar
        </button>
      </div>
