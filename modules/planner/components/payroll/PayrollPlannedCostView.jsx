...
import styles from "@/modules/planner/styles/components/payroll/PayrollPlannedCostView.module.scss";
  ...
  useEffect(() => {
    ...
    async function loadPlannedCost() {
      ...
      try {
        ...
        const response = await fetch(`/api/planner/payroll/planned-cost?${params.toString()}`);
