...
import { DailyAttendance } from "@/modules/planner/models";
    ...
    >
      <div className={styles.home}>
        <section className={styles.hero}>
          ...
          <Link className={styles.primaryAction} href={planningModulePath("/attendance/uploads")}>
            <UploadCloud size={19} />
            <span>Cargar picadas</span>
            <ArrowRight size={17} />
          </Link>
        </section>
