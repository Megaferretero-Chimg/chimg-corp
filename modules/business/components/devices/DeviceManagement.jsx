  ...
  return (
    <div className={styles.stack}>
      ...
      <section className={styles.panel}>
        <div className={styles.panelHead}><div><p className={styles.eyebrow}>Cajas instaladas</p><h2>Dispositivos</h2></div><div className={styles.panelActions}>{canManage ? <button type="button" className={styles.createKeyButton} onClick={openKeyModal}><KeyRound size={16} /> Crear llave</button> : null}</div></div>
